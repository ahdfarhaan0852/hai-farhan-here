...
import { ExternalLink, Code2, X, BarChart3, Info } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";
import { Projects3DGrid, type ProjectItem } from "./3d/Projects3DGrid";
...
export const Projects: React.FC<ProjectsProps> = ({ lang }) => {
  ...
  return (
    <section id="projects" className="relative w-full border-t border-brand-rose-dust/30 dark:border-brand-plum-muted/20">
      {/* Interactive 3D Floating Side Projects Grid */}
      <Projects3DGrid
              ...
              <div className="sticky top-0 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-md border-b border-neutral-200 dark:border-neutral-800 p-6 flex items-center justify-between z-10">
                <div>
                  <span className="font-mono text-[10px] tracking-widest text-brand-lavender-soft dark:text-brand-lavender-bright uppercase block mb-1">
                    {selectedProject.dateBadge} • {selectedProject.category}
                  </span>
