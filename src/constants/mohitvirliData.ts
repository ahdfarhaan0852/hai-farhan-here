...
export const AHMAD_FARHAN_WORK_TIMELINE: WorkTimelinePointData[] = [
  {
    ...
    subtitle: "Pendidikan Menengah Keagamaan & Ketua Gugus Depan Pramuka (400+ Anggota)",
    position: "right",
  },
  {
    ...
    subtitle: "S1 Teknik Informatika - Data Science (Python), AI & Basis Data MySQL",
    position: "left",
  },
  {
    point: new THREE.Vector3(-3, -1, -6),
    year: "2023 - Sekarang",
    title: "alif-parcel Retail",
    subtitle: "Pendiri & Pengelola Operasional Usaha Retail Lokal Parcel & Hampers",
    position: "left",
  },
  {
    ...
    subtitle: "Atlet Angkat Beban Nasional - Kedisiplinan & Ketahanan Fisik Atletik",
    position: "left",
  },
  {
